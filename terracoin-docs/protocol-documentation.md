...
This document describes the protocol extensions for all additional functionality build into the Terracoin protocol. This doesn't include any of the Bitcoin protocol, which has been left intact in the Terracoin project. For more information about the core protocol, please see https://en.bitcoin.it/w/index.php?title#Protocol_documentation&action#edit
...
| Field Size | Field Name | Data type | Description |
| ---------- | ----------- | --------- | -------- |
| 41 | vin | [CTxIn](#ctxin) | The unspent output which is holding 5000 TRC
| # | addr | [CService](#cservice) | IPv4 address of the masternode
| 33-65 | pubKeyCollateralAddress | [CPubKey](#cpubkey) | CPubKey of the main 5000 TRC unspent output
...
| ---------- | ---------- | ----------- | ----------- |
| 10001 | 1 | INSTANTSEND_ENABLED | Turns on and off InstantSend network wide
| 10002 | 2 | INSTANTSEND_BLOCK_FILTERING | Turns on and off InstantSend block filtering
| 10003 | 3 | INSTANTSEND_MAX_VALUE | Controls the max value for an InstantSend transaction (currently 20000 TRC)
| 10004 | 4 | MASTERNODE_PAYMENT_ENFORCEMENT | Requires masternodes to be paid by miners when blocks are processed
...
| Field Size | Field Name | Data type | Description |
| ---------- | ----------- | --------- | -------- |
| 41 | vin1 | [CTxIn](#ctxin) | The unspent output which is holding 5000 TRC for masternode 1
| 41 | vin2 | [CTxIn](#ctxin) | The unspent output which is holding 5000 TRC for masternode 2
