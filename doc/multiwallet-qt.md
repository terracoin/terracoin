...
Only requiring some minor changes is terracoin.cpp.
...
Changes to terracoin.cpp
----------------------
terracoin.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
