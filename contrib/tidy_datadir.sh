...
case $LEVEL in
  0)
    echo "Error: no Terracoin datadir detected."
    exit 1
    ;;
  1)
    echo "Detected old Terracoin datadir (before 0.7)."
    echo "Nothing to do."
    exit 0
    ;;
  2)
    echo "Detected Terracoin 0.7 datadir."
    ;;
  3)
    echo "Detected Terracoin pre-0.8 datadir."
    ;;
  4)
    echo "Detected Terracoin 0.8 datadir."
    ;;
esac
