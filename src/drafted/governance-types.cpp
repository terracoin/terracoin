...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "TerracoinNetwork") type = TerracoinNetwork;
    if(strType == "TerracoinNetworkVariable") type = TerracoinNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == TerracoinNetwork) s = "TerracoinNetwork";
    if(type == TerracoinNetworkVariable) s = "TerracoinNetworkVariable";
