 ...
 *
 *   // network
 *   CTerracoinNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.terracoin.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CTerracoinNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
public:
    CTerracoinNetwork(UniValue objIn)
    {
...
// // can be under: TerracoinNetwork
// //   -- signature requirements : Key1(User)
// class CTerracoinNetworkVariable : public CGovernanceObject
// {
// private:
...
//     //     return (IsType() == TerracoinNetwork);
//     // }
