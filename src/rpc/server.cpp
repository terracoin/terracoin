...
{ //  category              name                      actor (function)         okSafeMode
  //  --------------------- ------------------------  -----------------------  ----------
    ...
    /* Terracoin features */
    { "terracoin",               "masternode",             &masternode,             true  },
    { "terracoin",               "masternodelist",         &masternodelist,         true  },
    { "terracoin",               "masternodebroadcast",    &masternodebroadcast,    true  },
    { "terracoin",               "gobject",                &gobject,                true  },
    { "terracoin",               "getgovernanceinfo",      &getgovernanceinfo,      true  },
    { "terracoin",               "getsuperblockbudget",    &getsuperblockbudget,    true  },
    { "terracoin",               "voteraw",                &voteraw,                true  },
    { "terracoin",               "mnsync",                 &mnsync,                 true  },
    { "terracoin",               "spork",                  &spork,                  true  },
    { "terracoin",               "getpoolinfo",            &getpoolinfo,            true  },
    { "terracoin",               "sentinelping",           &sentinelping,           true  },
#ifdef ENABLE_WALLET
    { "terracoin",               "privatesend",            &privatesend,            false },
