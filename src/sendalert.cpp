...
2. run terracoind with -printalert or -sendalert like this:
   /path/to/terracoind -printalert
...
void ThreadSendAlert()
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see https://www.terracoin.org";
