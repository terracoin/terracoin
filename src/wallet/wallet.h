...
enum AvailableCoinsType
{
    ...
    ONLY_DENOMINATED,
    ONLY_NONDENOMINATED,
    ONLY_COLLATERAL, // find masternode outputs including locked ones (use with caution)
...
public:
    ...
    /// Get 5000TRC output and keys which can be used for the Masternode
    ...
    bool CreateTransaction(const std::vector<CRecipient>& vecSend, CWalletTx& wtxNew, CReserveKey& reservekey, CAmount& nFeeRet, int& nChangePosRet,
                           std::string& strFailReason, const CCoinControl *coinControl = NULL, bool sign = true, AvailableCoinsType nCoinType=ALL_COINS, bool fUseInstantSend=false, CAmount feeOverride=0);
