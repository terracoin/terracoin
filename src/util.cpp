...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\TerracoinCore
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\TerracoinCore
    // Mac: ~/Library/Application Support/TerracoinCore
    // Unix: ~/.terracoincore
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "TerracoinCore";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/TerracoinCore";
#else
    // Unix
    return pathRet / ".terracoincore";
#endif
#endif
}
