...
<context>
    ...
    <message>
        ...
        <translation>Terracoin核心現在要關閉，以便完成加密程序。請注意，加密錢包不能完全防止入侵你的電腦的惡意程式偷取terracoins。</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>發生致命錯誤。Terracoin核心軟體不再能安全地繼續運行下去，程式將會關閉。</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>&lt;h3&gt;匿名發送基礎知識&lt;/h3&gt; 匿名發送通過隱藏您的資金來源為您提供真正的財務隱私。您的錢包中所有的Terracoin都由不同的“輸入”組成，您可以將其視為分開的離散硬幣。&lt;br&gt; 匿名發送使用創新的方法將您的輸入與其他兩個人的輸入相結合，而過程中不會讓您的Terracoin離開您的錢包。每時每刻，您仍然控制著您的錢。&lt;hr&gt; &lt;b&gt;匿名發送的運作原理如下:&lt;/b&gt;&lt;ol type="1"&gt; &lt;li&gt;匿名發送首先將您的交易分柝成多個標準面額的交易。這些標準面額分別為0.01 TRC, 0.1 TRC, 1 TRC 和10 TRC --有點像您每天使用的紙幣。&lt;/li&gt; &lt;li&gt;您的錢包然後發送請求到網絡上有專門配置的軟件節點，稱為“主節點”。這些主節點會收到您希望混合一些資金的通知。沒有可識別的信息發送到主節點，所以他們永遠不會知道你是"誰"。&lt;/li&gt; &lt;li&gt;當另外兩個人發送類似的消息時，表示希望混合相同的面額的話，混合會話就會開始。相關的主節點會混合這些輸入，並指示所有三個用戶的錢包將已經轉換了輸入的交易支付給自己。你的錢包直接支付給自己，但是付給不同的位址 (稱之為找零位址)。&lt;/li&gt; &lt;li&gt;為了完全掩蓋您的資金來源，您的錢包必須以每個面額來重複此過程數次。每次這個過程完成後，都稱之為一個 "循環"。每個循環的匿名發送都會令確定您的資金來源的工作倍加困難。&lt;/li&gt; &lt;li&gt;這種混合過程發生在後台，而不需要您進行任何操作。當您想進行交易時，您的資金將已被匿名處理。不需再花額外的時間等待。&lt;/li&gt; &lt;/ol&gt; &lt;hr&gt;&lt;b&gt;重要:&lt;/b&gt;您的錢包只能擁有1000個"找零位址。" 每次混合事件發生時，最多會使用9個找零位址。這意味著這1000個位址可以容許100次的混合事件。當其的中900個已經被使用後，您的錢包必須創建更多的位址。如果您啟用了自動備份，則只能夠這樣做。&lt;br&gt;因此，禁用備份的用戶也將禁用匿名發送。&lt;hr&gt;如欲了解更多信息請參閱&lt;a href="https://wiki.terracoin.io/index.php/PrivateSend"&gt;https://wiki.terracoin.io/index.php/PrivateSend&lt;/a&gt;</translation>
    </message>
</context>
<context>
    <name>Intro</name>
...
<context>
    ...
    <message>
        ...
        <translation>最近的交易可能尚未顯示，因此您的錢包的餘額可能不正確。 一旦你的錢包完成與Terracoin網絡的同步，這個信息將是正確的，如下所述。</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>系統登入時啟動Terracoin核心(&amp;S)</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Terracoin核心程序還沒有安全退出...</translation>
    </message>
    <message>
        <source>Amount</source>
        <translation>金額</translation>
...
<context>
    ...
    <message>
        ...
        <translation>手續費將從發送金額中扣除。接收者將收到的Terracoin金額將會比您在金額字段中輸入的金額為少。 如果選擇了多個收款人，該費用將會被平均攤分。</translation>
    </message>
    <message>
...
<context>
  ...
  <message>
    ...
    <translation>版權為Terracoin核心開發人員自西元 2017 至 %i 年起所有</translation>
  </message>
    <message>
    ...
    <message>
        ...
        <translation>在本次交易中，無法找到不等於 1000 TRC的足夠未除名資金進行匿名發送。</translation>
    </message>
    <message>
