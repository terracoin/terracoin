    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Terracoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and terracoin: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Terracoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about Terracoin Core"));
    ...
    openAction->setStatusTip(tr("Open a terracoin: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Terracoin Core help message to get a list with possible Terracoin Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Terracoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumBlocks(int count, const QDateTime& blockDate, double nVerificationProgress, bool header)
{
    ...
    if (walletFrame)
    {
        if(secs < 20*60) // 90*60 in bitcoin, 25*60 in dash
        {
...
{
    QString strTitle = tr("Terracoin Core"); // default title
    ...
    // Append title to "Terracoin Core - "
    if (!msgType.isEmpty())
        strTitle += " - " + msgType;
