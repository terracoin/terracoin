...
class TxnMallTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # 40 TRC serialized is 00286bee00000000
        pos0 = 2*(4+1+36+1+4+1)
        ...
        # Check node0's total balance; should be same as before the clone, + 40 TRC for 2 matured,
        ...
        assert_equal(self.nodes[0].getbalance("foo"), 487 + tx1["amount"] + tx1["fee"])
